...
export default {
  ...
  mounted() {
    ...
    scene.add(ambient);
    // console.log(scene)
    // console.log(scene.children)rial); //网格模型对象Mesh
    scene.add(mesh); //网格模型添加到场景中
    ...
    renderer.setClearColor('#ccc', 0.5); //设置背景颜色
    // this.$refs.webglContainer.$vnode = renderer.domElement;
